...
// The adapter's own error-text helper — the panel imports it rather than keeping a
// second copy (fleet rule: the helper exists once per repo, `error-text-helper`).
